 ...
 *
 * <p>Access is granted by SecurityConfig on {@code /admin/**}. Nothing here
 * mutates: an ADMIN who needs to change a playlist they do not own has it
 * transferred first (deactivation or demotion of the owner does that).
 */
@Controller
