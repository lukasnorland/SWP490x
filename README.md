...
| P-06a User Management | Implemented — create + credentials email (BR-15), filters, pagination, deactivate/reactivate with session invalidation, role change, and resend |
